...
def main():
    print("Starting Wizard101 Quiz Solver...")
    load_dotenv()
    with sync_playwright() as p:
        ...
        for title in random.sample(list(quizzes.keys()), 10):   
            ...
            for i in range(1, 13):
                ...
                try:
                    ...
                    if not correct_answer_found:
                        with open("new_questions.txt", "a", encoding="utf-8") as f:
            ...
            if recaptcha_found:
                ...
                while recaptcha_solved == False:
                    ...
                    try:
                        ...
                        play_audio_button = recaptcha_iframe.locator("button", has_text="PLAY")
            ...
            try:
                ...
                if quiz_score != "100%":
                    with open("quiz_log.txt", "a", encoding="utf-8") as log_file:
